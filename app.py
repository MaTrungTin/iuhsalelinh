...
cred = credentials.Certificate('iuh-20002915-45339-firebase-adminsdk-6mgip-b7afbbe51c.json')
appLoadData = firebase_admin.initialize_app(cred)

dbFireStore = firestore.client()

queryResults = list(dbFireStore.collection(u'tbI-20002915').stream())
    ...
    children=[
        html.Div(
            children=[
                ...
                html.H4(
                    "IUH-DHHTTT16C-20002435-Huỳnh Thị Thùy Linh ", className="header-title"
                )
            ],
            className="header",
        ),
